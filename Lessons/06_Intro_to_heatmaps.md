...
```
![heatmap1](https://github.com/cxli233/Quick_data_vis/blob/main/Results/06_abc_1.png)
...
```
![gene_heatmap1](https://github.com/cxli233/Quick_data_vis/blob/main/Results/06_genes_1.png)
...
```
![gene_heatmap2](https://github.com/cxli233/Quick_data_vis/blob/main/Results/06_genes_2.png)
...
```
![rainbow](https://github.com/cxli233/Quick_data_vis/blob/main/Results/06_abc_2.png)
...
```
![bad heatmap](https://github.com/cxli233/Quick_data_vis/blob/main/Results/06_genes_3.png)
